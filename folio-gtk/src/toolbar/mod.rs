...
impl FormattingToolbar {
    pub fn new(state: Rc<RefCell<EditorState>>, canvas: DrawingArea) -> Self {
        ...
        for (icon, tip) in [
            ("format-text-bold-symbolic",          "Bold (Phase 4)"),
            ("format-text-italic-symbolic",        "Italic (Phase 4)"),
            ("format-text-underline-symbolic",     "Underline (Phase 4)"),
            ("format-text-strikethrough-symbolic", "Strikethrough (Phase 4)"),
        ] {
        ...
        for icon in ["format-justify-left-symbolic", "format-justify-center-symbolic",
